...
(function () {
    ...
    oren.component("support", {
        templateUrl: "app/views/contact.html",
        controller: function contactController() {
            this.phone = "+27 (087) 057-1581",
            this.fax = "086 606 4081";
            this.email = "orenlaboratories@gmail.com";
            this.tracing = "goodwish@axxess.co.za";
            this.website = "https://www.orenlabs.com";
        }
    })
    ...
    oren.component("renew", {
        ...
        controller: function renewalController() {
            this.isForm = true;
            this.isNotify = false;
